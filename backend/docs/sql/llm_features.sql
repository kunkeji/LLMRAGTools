...
CREATE TABLE `llm_feature_mappings` (
    ...
    CONSTRAINT `fk_feature_mappings_channel` FOREIGN KEY (`llm_model_id`) REFERENCES `llm_channels` (`id`) ON DELETE CASCADE,
